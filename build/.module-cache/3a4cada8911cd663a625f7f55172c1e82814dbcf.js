...
var Tour=React.createClass({displayName: "Tour",  
  render: function() {  	
    ...
    return (
      React.createElement("div", {className: "card hoverable row card-tours"}, 
        ...
        React.createElement("a", {href: urlBase+"tours/"+this.props.data.tour.clave+".html"}, React.createElement("h5", {className: "tituloCard left-align"}, this.props.data.tour.name)), 
        ...
        React.createElement("div", {className: "col s12 m4 l4"}, 
        	...
        	React.createElement("div", {className: "col s12 m8 offset-m2 l6 offset-l3"}, 
        		React.createElement("a", {href: urlBase+"tours/"+this.props.data.tour.clave+".html?"+request, className: "col s12 btn red"}, 
        			"BOOK"
        		)
        	)	
        )
