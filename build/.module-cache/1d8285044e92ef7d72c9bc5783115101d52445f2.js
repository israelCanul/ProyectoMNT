  ...
  render: function() {  	
    ...
    return (
      React.createElement("div", {className: "card-panel hoverable row card-tours"}, 
        ...
        React.createElement("a", {href: urlDestino, className: "red-text"}, 
        ...
        React.createElement("div", {className: "col s12 m4 l4 precioDetalle"}, 
        	...
        	React.createElement("div", {className: "col s12 m8 offset-m2 l6 offset-l3"}, 
        		React.createElement("a", {href: urlBase+"tours/"+this.props.data.tour.clave+".html?TourId="+this.props.data.tour.clave, className: "col s12 btn red"}, 
        			"BOOK"
        		)
        	)	
        )
