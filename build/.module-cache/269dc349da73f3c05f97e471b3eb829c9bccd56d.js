  ...
  render: function() {
    return (
      React.createElement("div", {className: "card-panel hoverable row card-tours"}, 
        ...
        React.createElement("a", {href: urlBase+"tours/"+this.props.data.tour.clave+".html"+dataUrl+"&tour_destination="+this.props.data.tour.name}, React.createElement("h5", {className: "tituloCard red-text left-align"}, this.props.data.tour.name)), 
