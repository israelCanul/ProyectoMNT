...
var Tour=React.createClass({displayName: "Tour",  
  render: function() {
    ...
    return (
      React.createElement("div", {className: " card-panel hoverable row card-tours elementList list-item"}, 
        ...
        React.createElement("div", {className: "col s12 m4 l4 precioDetalle"}, 
        	...
        	React.createElement("div", {className: "right-align col s10 price"}, 
        		React.createElement("span", null, "$ ", this.props.data.price.currency), React.createElement("span", {className: "price"}, " ", this.props.data.price.average)
        	), 
...
var ListTours=React.createClass({displayName: "ListTours",
	render:function(){
		...
		if(this.props.data.length==0){
			...
			return(
				React.createElement("div", {className: "commentList list box"}, 
					tours
				)
			);
		}
