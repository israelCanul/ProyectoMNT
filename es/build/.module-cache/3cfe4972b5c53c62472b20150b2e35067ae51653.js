  ...
  render: function() {  	
    ...
    return (
      React.createElement("div", {className: "card hoverable row"}, 
        ...
        React.createElement("a", {hrfe: true}, React.createElement("h4", {className: "left-align"}, this.props.data.tour.name)), 
		React.createElement("input", {type: "hidden", name: "idTour", value: this.props.data.tour.id}), 
        React.createElement("p", null, 
        this.props.data.description.short
        ), 

        React.createElement("a", {href: urlBase+"tours/"+this.props.data.destination.clave+".html", className: "red-text"}, 
        ...
        React.createElement("div", {className: "col s12 m4 l4"}, 
        	...
        	React.createElement("div", {className: "col s12 m8 offset-m2 l6 offset-l3"}, 
        		React.createElement("a", {href: urlBase+"tours/"+this.props.data.destination.clave+".html", className: "col s12 btn red"}, 
        			"BOOK"
        		)
        	)	
        )
