				    ...
				    <div class="nav-wrapper">
				      <form action="<?=$this->createUrl('site/buscar')?>" method='post'>
				        <div class="input-field" style="">
				          <input id="search" type="search" name="word_search" style="border-bottom: 2px solid white;"  required>
				          <label for="search"><i class="material-icons red-text">search</i></label>
				        </div>
				      </form>
				    </div>
				  </nav>
					...
					<div class="row">
						<div class="col s12  white-text medium">
					       <div class="input-field col s12">
					         ...
					         <label for="name_suscribe white-text" class="label-activo">Name</label>
					       </div>
						</div>
						<div class="col s12  white-text medium">
					       <div class="input-field col s12">
					         <i class="material-icons prefix white-text">email</i>
					         <input id="email_suscribe" type="email" name='email_suscribe' required >
					         <label for="email_suscribe white-text" class="label-activo">Email</label>
					       </div>
						</div>
						<div class="col s12  white-text medium">
					       <div class="input-field col s12">
					         ...
					         <label for="country_suscribe white-text" class="label-activo">Country</label>
					       </div>
						</div>
						<div class="col s12  white-text medium">
					       <div class="input-field col s12">
					         ...
					         <label for="city_suscribe white-text" class="label-activo">City</label>
					       </div>
						</div>
						<div class="col s12  white-text medium">
						  <button id="submit_suscribe" style="float:right" class="btn waves-effect waves-light"  name="action">Submit
