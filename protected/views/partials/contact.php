...
<div id="contactMail" style="width:800px; text-align:center; margin:20px auto;">
	...
	<div style="padding:0; margin:0;">
		<table border="0" cellspacing="10" cellpadding="20" style="width:800px; ">
			<tr class="row">
				<td width="50%"><strong>Name: </strong><span class="tdMail"><?php echo ucwords($_POST['name']); ?></span></td>
				<td width="50%"><strong>Email: </strong><span class="tdMail"><?php echo $_POST['email']; ?></span></td>
			</tr>
			<tr class="row">
				<td width="50%"><strong>Telephone: </strong><span class="tdMail"><?php echo $_REQUEST['phone']; ?></span></td>
				<td width="50%"><strong>Country: </strong><span class="tdMail"><?php echo $_REQUEST['country']; ?></span></td>
			</tr>
			<tr class="row">
				<td rowspan="5" colspan="2"  style="text-align:justify;">
					<strong>Comments: </strong><span class="tdMail"><?php echo $_REQUEST['message']; ?></span>
				</td>
			</tr>
		</table>
	</div>
