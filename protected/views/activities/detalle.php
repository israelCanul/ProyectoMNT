<div class="content">
	...
	<section class="contentSide detail">
		...
		<div class="insideBooking">
			<?php $this->widget('application.components.Bookingbox',array("size"=>"small","cProd"=>"tours", "selectAdulto" => $selectAdulto)); ?>
		</div>
			...
			<div class='OptionResult rates'>
				<?php
					...
					foreach($Tarifas as $z){
						echo "<form method='post' action='".$this->createUrl("tours/agregar")."'>";
