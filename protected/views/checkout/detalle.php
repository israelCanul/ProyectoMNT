				...
				<div class="bloque div_payment">
					...
					<div class="bloque card-panel method_payment" >
						<p class="bloque fontsize_mobil" >
							...
							<label for="cards">Foreign or National 
							...
							<table class="banks_adquiring_cars" cellpadding="0" cellspacing="0" width="100%">
								<tbody>
									...
									<tr>
										...
										<td>
											<input class="method_gateway_selector" checked="checked" type="radio" name="gateway_method" value="santander_1" role="needcard_debito1" />
										</td>
										<td>
