<div class="row">
	...
	<div class="col s12 "><br></div>
		<h3>Result of <?=$_REQUEST['word_search']?></h3>
		<? //print_r($resultados);?>
	       ...
	       <ul class="collection with-header">
	        ...
	        if(count($resultados['destinos'])>0){
	        	echo '<li class="collection-header"><h4 class="red-text">Destinations</h4></li>';
	        ...
	        if(count($resultados['hoteles'])>0){
	        	echo '<li class="collection-header col s12"><h4 class="red-text">Hotels</h4></li>';
		        foreach ($resultados['hoteles'] as $key => $value) {
		        	echo '<li class="collection-item col s12" style="padding: 5px;"><div><a href="'.$value["url"].'"  target="_blank">'.$value["label"].'</a><a href="'.$value["url"].'"  target="_blank" class="secondary-content"><i class="material-icons">send</i></a></div></li>'; 
		        }
	    	}
	        if(count($resultados['tours']['dest'])>0){
	        	echo '<li class="collection-header col s12"><h4 class="red-text">Tours - Destinations</h4></li>';
	        ...
	        if(count($resultados['tours']['sup'])>0){
	        	echo '<li class="collection-header col s12"><h4 class="red-text">Tours - Supplier</h4></li>';
