<?php
/**
 * Clase para generacion de enu hover
 */
class BreadCrumb extends CWidget {
    ...
    public $firstCrumb = array('Home' => array('name' => 'Home', 'url' => array('site/index')),
        'Livestream' => array('name' => 'Livestream', 'url' => array('site/livestream')),
        'Video HD' => array('name' => 'Video HD', 'url' => array('site/videohd')),
        'Fotografía' => array('name' => 'Fotografía', 'url' => array('site/photography')),
        'Trash the Dress' => array('name' => 'Trash the Dress', 'url' => array('site/trashthedress')),
        'Fotografía y video' => array('name' => 'Fotografía y video', 'url' => array('site/photographyandvideo')),
        'Nuestro equipo' => array('name' => 'Nuestro equipo', 'url' => array('site/ourteam'))
    );//
    public $excludeCrumbs = array('Login');//
    public $crumbs2Show = 6;//3
